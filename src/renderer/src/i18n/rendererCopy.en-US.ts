...
export const enUS: Record<TranslationKey, string> = {
  ...
  "config.dsh.tab.pluginMarket": "Plugin Market",
  "config.dsh.tab.mcp": "MCP Servers",
  "config.dsh.tab.skills": "Skills",
  "config.dsh.skillHint": "Manage user skills (~/.dsh/skills/<name>/SKILL.md). Saved instantly: the host picks changes up live; invoke with /skill-name in the composer.",
  "config.dsh.skillCreate": "New skill",
  "config.dsh.skillCreateTitle": "New skill",
  "config.dsh.skillEditTitle": "Edit skill",
  "config.dsh.skillName": "Skill name (kebab-case: a-z0-9 and hyphens)",
  "config.dsh.skillNameReadonlyHint": "The name is the folder key and cannot be renamed; delete and recreate instead.",
  "config.dsh.skillDescription": "Description (required, shown in the catalog and / invocation)",
  "config.dsh.skillWhenToUse": "When to use (optional)",
  "config.dsh.skillContent": "Content (Markdown)",
  "config.dsh.skillEdit": "Edit",
  "config.dsh.skillRemove": "Remove",
  "config.dsh.skillConfirmRemove": "Confirm",
  "config.dsh.skillEmpty": "No skills yet. Click \"New skill\" to create the first one.",
  "config.dsh.skillNotFound": "Skill not found or already removed",
  "config.dsh.skillInvalidName": "Skill name must be kebab-case (a-z0-9 and hyphens)",
  "config.dsh.skillInvalidDescription": "Description cannot be empty",
  "config.dsh.skillCreated": "Skill created; invoke with /name",
  "config.dsh.skillUpdated": "Saved; host picked up the change",
  "config.dsh.skillRemoved": "Skill removed",
  "config.dsh.mcpHint": "Manage MCP servers (requires the dsh-mcp-manager plugin). Add/toggle writes to the web profile patch; takes effect after a host restart.",
  "config.dsh.mcpAddServer": "Add server",
  "config.dsh.mcpId": "Entry ID (alphanumeric -_, max 64)",
  "config.dsh.mcpServerName": "Server name (tool prefix mcp__<name>__, max 32)",
  "config.dsh.mcpTransport": "Transport",
  "config.dsh.mcpUrl": "URL (streamable-http)",
  "config.dsh.mcpCommand": "Command (stdio)",
  "config.dsh.mcpArgs": "Args (space-separated)",
  "config.dsh.mcpEnabled": "Enabled",
  "config.dsh.mcpDisabled": "Disabled",
  "config.dsh.mcpEnable": "Enable",
  "config.dsh.mcpDisable": "Disable",
  "config.dsh.mcpProbe": "Test",
  "config.dsh.mcpRemove": "Remove",
  "config.dsh.mcpConfirmRemove": "Confirm",
  "config.dsh.mcpEmpty": "No MCP servers configured yet.",
  "config.dsh.mcpUnavailable": "MCP management unavailable",
  "config.dsh.mcpInvalidId": "ID must be 1-64 alphanumeric or -_",
  "config.dsh.mcpInvalidName": "Server name must be 1-32 alphanumeric or -_",
  "config.dsh.mcpInvalidUrl": "Enter a valid http(s) URL",
  "config.dsh.mcpInvalidCommand": "Enter a start command",
  "config.dsh.mcpAddFailed": "Add failed",
  "config.dsh.mcpRemoveFailed": "Remove failed",
  "config.dsh.mcpToggleFailed": "Toggle failed",
  "config.dsh.mcpAddRestartHint": "Added; takes effect after a host restart",
  "config.dsh.mcpRestartHint": "Changed; takes effect after a host restart",
  "config.dsh.mcpProbeOk": "Connection OK",
  "config.dsh.mcpProbeFail": "Connection failed",
  "config.dsh.marketHint": "Install community plugins from the curated registry (awesome-dsh-plugin; installed into ~/.dsh/profiles/pistudio, hot-reloaded after install).",
  "config.dsh.marketTabAll": "All plugins",
  "config.dsh.marketTabInstalled": "Installed",
  "config.dsh.marketInstalledEmpty": "No plugins installed yet.",
  "config.dsh.marketNoSettings": "No settings UI",
  "config.dsh.marketNoSettingsHint": "This plugin registers no settings schema. Plugins with config items appear under the Plugin config tab; pure-UI plugins (e.g. dsh-mcp-manager) are managed by PiStudio built-in panels.",
  "config.dsh.marketSearchPlaceholder": "Search plugins…",
  "config.dsh.marketEmpty": "The market catalog is empty.",
  "config.dsh.marketLoading": "Loading the market catalog…",
  "config.dsh.marketBusyOther": "An install/uninstall is already in progress, please wait",
  "config.dsh.marketUnavailable": "Market unavailable",
  "config.dsh.marketInstall": "Install",
  "config.dsh.marketUninstall": "Uninstall",
  "config.dsh.marketConfirmUninstall": "Confirm",
  "config.dsh.marketInstalled": "Installed",
  "config.dsh.marketLive": "Active",
  "config.dsh.marketInstalling": "Installing",
  "config.dsh.marketInstalledToast": "Plugin installed",
  "config.dsh.marketUninstalledToast": "Plugin uninstalled",
  "config.dsh.marketInstallFailed": "Install failed",
  "config.dsh.marketUninstallFailed": "Uninstall failed",
