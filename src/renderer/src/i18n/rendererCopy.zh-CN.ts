...
export const zhCN = {
  ...
  "config.dsh.tab.pluginMarket": "插件市场",
  "config.dsh.tab.mcp": "MCP 服务器",
  "config.dsh.tab.skills": "技能",
  "config.dsh.skillHint": "管理用户级技能（~/.dsh/skills/<name>/SKILL.md）。保存即生效：host 实时感知，composer 里用 /技能名 调用。",
  "config.dsh.skillCreate": "新建技能",
  "config.dsh.skillCreateTitle": "新建技能",
  "config.dsh.skillEditTitle": "编辑技能",
  "config.dsh.skillName": "技能名（kebab-case：a-z0-9 和连字符）",
  "config.dsh.skillNameReadonlyHint": "技能名是文件目录键，不可重命名；可删后重建。",
  "config.dsh.skillDescription": "描述（必填，目录与 /调用展示用）",
  "config.dsh.skillWhenToUse": "何时使用（可选）",
  "config.dsh.skillContent": "内容（Markdown）",
  "config.dsh.skillEdit": "编辑",
  "config.dsh.skillRemove": "删除",
  "config.dsh.skillConfirmRemove": "确认删除",
  "config.dsh.skillEmpty": "暂无技能。点「新建技能」创建第一个。",
  "config.dsh.skillNotFound": "技能不存在或已删除",
  "config.dsh.skillInvalidName": "技能名需为 kebab-case（a-z0-9 和连字符）",
  "config.dsh.skillInvalidDescription": "描述不能为空",
  "config.dsh.skillCreated": "已创建技能，/技能名 即可调用",
  "config.dsh.skillUpdated": "已保存，host 已感知更新",
  "config.dsh.skillRemoved": "已删除技能",
  "config.dsh.mcpHint": "管理 MCP 服务器（需要先安装 dsh-mcp-manager 插件）。新增/启停写入 web profile patch，重启 host 后生效。",
  "config.dsh.mcpAddServer": "添加服务器",
  "config.dsh.mcpId": "条目 ID（字母数字-_，最长 64）",
  "config.dsh.mcpServerName": "服务器名（工具前缀 mcp__<名>__，最长 32）",
  "config.dsh.mcpTransport": "传输方式",
  "config.dsh.mcpUrl": "URL（streamable-http）",
  "config.dsh.mcpCommand": "命令（stdio）",
  "config.dsh.mcpArgs": "参数（空格分隔）",
  "config.dsh.mcpEnabled": "已启用",
  "config.dsh.mcpDisabled": "已停用",
  "config.dsh.mcpEnable": "启用",
  "config.dsh.mcpDisable": "停用",
  "config.dsh.mcpProbe": "测试连接",
  "config.dsh.mcpRemove": "删除",
  "config.dsh.mcpConfirmRemove": "确认删除",
  "config.dsh.mcpEmpty": "尚未配置 MCP 服务器。",
  "config.dsh.mcpUnavailable": "MCP 管理不可用",
  "config.dsh.mcpInvalidId": "ID 需为 1-64 位字母数字或 -_",
  "config.dsh.mcpInvalidName": "服务器名需为 1-32 位字母数字或 -_",
  "config.dsh.mcpInvalidUrl": "请输入有效的 http(s) URL",
  "config.dsh.mcpInvalidCommand": "请输入启动命令",
  "config.dsh.mcpAddFailed": "添加失败",
  "config.dsh.mcpRemoveFailed": "删除失败",
  "config.dsh.mcpToggleFailed": "切换失败",
  "config.dsh.mcpAddRestartHint": "已添加，重启 host 后生效",
  "config.dsh.mcpRestartHint": "已修改，重启 host 后生效",
  "config.dsh.mcpProbeOk": "连接正常",
  "config.dsh.mcpProbeFail": "连接失败",
  "config.dsh.marketHint": "从精选目录安装社区插件（awesome-dsh-plugin，安装到 ~/.dsh/profiles/pistudio，安装后热加载生效）。",
  "config.dsh.marketTabAll": "全部插件",
  "config.dsh.marketTabInstalled": "已安装",
  "config.dsh.marketInstalledEmpty": "尚未安装任何插件。",
  "config.dsh.marketNoSettings": "无设置界面",
  "config.dsh.marketNoSettingsHint": "该插件未注册配置项（无 schema）。带配置项的插件会出现在「插件配置」子 tab；纯 UI 型插件（如 dsh-mcp-manager）由 PiStudio 内置面板管理。",
  "config.dsh.marketSearchPlaceholder": "搜索插件…",
  "config.dsh.marketEmpty": "市场目录为空。",
  "config.dsh.marketLoading": "正在加载市场目录…",
  "config.dsh.marketBusyOther": "已有安装/卸载在进行中，请稍候",
  "config.dsh.marketUnavailable": "市场不可用",
  "config.dsh.marketInstall": "安装",
  "config.dsh.marketUninstall": "卸载",
  "config.dsh.marketConfirmUninstall": "确认卸载",
  "config.dsh.marketInstalled": "已安装",
  "config.dsh.marketLive": "已激活",
  "config.dsh.marketInstalling": "安装中",
  "config.dsh.marketInstalledToast": "插件安装成功",
  "config.dsh.marketUninstalledToast": "插件已卸载",
  "config.dsh.marketInstallFailed": "安装失败",
  "config.dsh.marketUninstallFailed": "卸载失败",
